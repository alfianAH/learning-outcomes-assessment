...
class CloTestCase(TestCase):
    def test_generate_nilai_clo_0_100(self):
        for i in range(1000):
    ...
    def test_generate_nilai_clo_0_80(self):
        for i in range(1000):
            nilai_akhir = random.random() * 80
    ...
    def test_generate_nilai_clo_0_70(self):
        for i in range(1000):
            nilai_akhir = random.random() * 70
    ...
    def test_generate_nilai_clo_0_60(self):
        for i in range(1000):
            nilai_akhir = random.random() * 60
    ...
    def test_generate_nilai_clo_0_50(self):
        for i in range(1000):
            nilai_akhir = random.random() * 50
    ...
    def test_generate_nilai_clo_0_20(self):
        for i in range(1000):
            nilai_akhir = random.random() * 20
    ...
    def test_generate_nilai_clo_0_10(self):
        for i in range(1000):
            nilai_akhir = random.random() * 10
